...
public class InicioAlu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<body>\n" + 
				...
				"            <div class='col-md-5 offset-md-3'>\n" + 
				"            <b>En esta p&aacute;gina se muestran las asignaturas en las que est&aacute;s matriculad@, además, podrás ver tu expediente si lo deseas.</b>\n" + 
				"            <br><b>Al pulsar en una podr&aacute;s acceder a tu calificaci&oacute;n o bien podrás acceder a tu expediente pulsando en el último botón.</b></div>\n" + 
				"        </div>\n" + 
				"        <br>  \n" + 
				"        <div class=\"row\">\n" + 
